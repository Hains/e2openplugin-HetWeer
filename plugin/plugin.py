...
def getLocWeer(iscity = None):
    ...
    try: 
        ...
        try:
            ...
            req = urllib.request.Request("http://claudck193.193.axc.nl/hetweer.php?cn="+text)
    ...
    if match:
        try:
            response = urllib.request.urlopen("http://api.buienradar.nl/data/forecast/1.1/all/"+match[0][0])
            antw = response.read()
            weatherData = json.loads(antw)
            return True
        except:
        ...
        try:
            if state[0] == _("Belgium") and newView:
                if type == _("Weather forecast-nl"):
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/radarmapbe/?ext=png&l=2&hist=0&forc=90&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                elif type == _("Drizzle"):
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/drizzlemapnl/?ext=png&l=2&hist=50&forc=0&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/sunmapnl/?ext=png&l=2&hist=0&forc=50&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                    legend = False
                elif type == _("Thunder radar"):
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/lightningnl/?ext=png&l=2&hist=50&forc=0&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/satvisual2/?ext=png&l=2&hist=50&forc=0&step=0&w=550&h=512', '/tmp/HetWeer/00.png')
                    legend = False
                ...
                if type == _("Weather forecast-nl"):
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/radarmapnl/?ext=png&l=2&hist=0&forc=50&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                elif type == _("Drizzle"):
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/drizzlemapnl/?ext=png&l=2&hist=50&forc=0&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                elif type == _("Clouds radar"):
                    urllib.urlretrieve('http://api.buienradar.nl/image/1.0/cloudmapnl/?ext=png&l=2&hist=50&forc=0&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/weathermapnl/?type=zicht&ext=png&l=2&hist=9&forc=1&step=0&w=550&h=512', '/tmp/HetWeer/00.png')
                    legend = False
                elif type == _("Sun radar"):
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/sunmapnl/?ext=png&l=2&hist=0&forc=50&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                    legend = False
                ...
                if type == _("Weather forecast-nl"):
                    ...
                    urllib.request.urlretrieve('http://api.buienradar.nl/image/1.0/radarmapeu/?ext=png&l=2&hist=0&forc=50&step=0&h=512&w=550', '/tmp/HetWeer/00.png')
                elif type == _("Thunder radar"):
...
def main(session, **kwargs):
    if checkInternet():
        ...
        try:
            response = urllib.request.urlopen("http://claudck193.193.axc.nl/wallpapers/daa.php?data")
